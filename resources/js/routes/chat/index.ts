...
* @see app/Http/Controllers/ChatController.php:99
...
/**
* @see \App\Http\Controllers\ChatController::createOrGet
* @see app/Http/Controllers/ChatController.php:134
* @route '/chat/create-or-get'
*/
export const createOrGet = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: createOrGet.url(options),
    method: 'post',
})

createOrGet.definition = {
    methods: ["post"],
    url: '/chat/create-or-get',
} satisfies RouteDefinition<["post"]>
...
* @route '/chat/create-or-get'
*/
createOrGet.url = (options?: RouteQueryOptions) => {
    return createOrGet.definition.url + queryParams(options)
}
...
* @route '/chat/create-or-get'
*/
createOrGet.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: createOrGet.url(options),
    method: 'post',
})
...
* @route '/chat/create-or-get'
*/
const createOrGetForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: createOrGet.url(options),
    method: 'post',
})
...
* @route '/chat/create-or-get'
*/
createOrGetForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: createOrGet.url(options),
    method: 'post',
})

createOrGet.form = createOrGetForm

const chat = {
    index: Object.assign(index, index),
    show: Object.assign(show, show),
    store: Object.assign(store, store),
    createOrGet: Object.assign(createOrGet, createOrGet),
}
