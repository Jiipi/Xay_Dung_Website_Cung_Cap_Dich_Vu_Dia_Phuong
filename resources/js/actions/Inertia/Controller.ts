...
* @route '/policy'
*/
const Controller27898d97a1ef428c8c1af760516b4346 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller27898d97a1ef428c8c1af760516b4346.url(options),
    method: 'get',
})

Controller27898d97a1ef428c8c1af760516b4346.definition = {
    methods: ["get","head"],
    url: '/policy',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/policy'
*/
Controller27898d97a1ef428c8c1af760516b4346.url = (options?: RouteQueryOptions) => {
    return Controller27898d97a1ef428c8c1af760516b4346.definition.url + queryParams(options)
}
...
* @route '/policy'
*/
Controller27898d97a1ef428c8c1af760516b4346.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller27898d97a1ef428c8c1af760516b4346.url(options),
    method: 'get',
})
...
* @route '/policy'
*/
Controller27898d97a1ef428c8c1af760516b4346.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller27898d97a1ef428c8c1af760516b4346.url(options),
    method: 'head',
})
...
* @route '/policy'
*/
const Controller27898d97a1ef428c8c1af760516b4346Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller27898d97a1ef428c8c1af760516b4346.url(options),
    method: 'get',
})
...
* @route '/policy'
*/
Controller27898d97a1ef428c8c1af760516b4346Form.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller27898d97a1ef428c8c1af760516b4346.url(options),
    method: 'get',
})
...
* @route '/policy'
*/
Controller27898d97a1ef428c8c1af760516b4346Form.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller27898d97a1ef428c8c1af760516b4346.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
Controller27898d97a1ef428c8c1af760516b4346.form = Controller27898d97a1ef428c8c1af760516b4346Form
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
const Controller = {
    ...
    '/policy': Controller27898d97a1ef428c8c1af760516b4346,
